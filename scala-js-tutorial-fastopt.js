...
/** @constructor */
function $c_LMain$() {
  this.LMain$__f_f = null;
  $n_LMain$ = this;
  this.LMain$__f_f = new $c_sjsr_AnonFunction1(((e$2) => {
    var x = ("Event handled: " + e$2);
...
$c_LMain$.prototype.main__AT__V = (function(args) {
  ...
  document.addEventListener("load", $m_sjs_js_Any$().fromFunction1__F1__sjs_js_Function1(this.LMain$__f_f), $uZ(document.addEventListener$default$3))
});
